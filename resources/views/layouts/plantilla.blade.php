    ...
    <nav class="flex items-center justify-between flex-wrap bg-white p-6 fixed w-full z-10 top-0">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0" id="nav-content">
            <ul class="list-reset lg:flex justify-end flex-1 items-center text-xl">
                <li class="mr-3">
                    <a class="inline-block py-2 px-4 text-yellow-500 " href="{{route('index')}}">Inicio</a>
                </li>
                <li class="mr-3">
                    <a class="inline-block text-black hover:text-yellow-500  py-2 px-4"
        ...
        <div class="sm:flex sm:mt-auto">
            <div class=" mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="my-1"><a href="#" class="text-black  text-md hover:text-yellow-500">Proyectos
                            ejecutivos</b></span>
                    <span class="my-1"><a href="#" class="text-black  text-md hover:text-yellow-500">Construcción y/o
                            remodelaciones en general</a></span>
                    <span class="my-1"><a href="#" class="text-black  text-md hover:text-yellow-500">Ejecución y
                            supervisión de obras </a></span>
                    <span class="my-1"><a href="#" class="text-black  text-md hover:text-yellow-500">Trámites ante
                            entidades municipales, estatales y federales<a></span>
                    <span class="my-1"><a href="#" class="text-black  text-md hover:text-yellow-500">Unidad de
                            verificación de instalaciones eléctrica<a></span>
                    <span class="my-1"><a href="#" class="text-black  text-md hover:text-yellow-500">Servicio de
                            asesoría</a></span>
                    <span class="my-1"><a href="#" class="text-black  text-md hover:text-yellow-500">Venta e instalación
                ...
                <div class="flex flex-col">
                    ...
                    <span class="my-1"><i class="fa fa-mobile"></i><a href="#"
                            class="text-black ml-1.5 text-md hover:text-yellow-500"> 044 (998) 1022645</a></span>
                    <span class="my-1"><i class="fa fa-envelope"></i><a href="#"
                    ...
                    <div class="flex-wrap inline-flex py-2 space-x-3">
                        <a href="#" class="hover:text-yellow-500 text-black"> <svg viewBox="0 0 24 24"
